...
static void FileStream_SeekImpl(FileStream* self, MidiBigUInt pos) {
	((StandardFileStream*)self)->seek = pos;
}

static MidiBigUInt FileStream_TellImpl(FileStream* self) {
...
#ifdef DEBUG
	fprintf(stderr, "reading midi file into memory\n");
#endif
