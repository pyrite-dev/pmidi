...
var _GUSPatSynth_New = Module['_GUSPatSynth_New'] = makeInvalidEarlyAccess('_GUSPatSynth_New');
var _GUSPatSynth_Load = Module['_GUSPatSynth_Load'] = makeInvalidEarlyAccess('_GUSPatSynth_Load');
var _GUSPatSynth_Destroy = Module['_GUSPatSynth_Destroy'] = makeInvalidEarlyAccess('_GUSPatSynth_Destroy');
var _GUSPatSynth_Reset = Module['_GUSPatSynth_Reset'] = makeInvalidEarlyAccess('_GUSPatSynth_Reset');
var _GUSPatSynth_Unload = Module['_GUSPatSynth_Unload'] = makeInvalidEarlyAccess('_GUSPatSynth_Unload');
var _GUSPatSynth_Note = Module['_GUSPatSynth_Note'] = makeInvalidEarlyAccess('_GUSPatSynth_Note');
var _GUSPatSynth_NoteOffAll = Module['_GUSPatSynth_NoteOffAll'] = makeInvalidEarlyAccess('_GUSPatSynth_NoteOffAll');
var _GUSPatSynth_SetBank = Module['_GUSPatSynth_SetBank'] = makeInvalidEarlyAccess('_GUSPatSynth_SetBank');
var _GUSPatSynth_SetBankMSB = Module['_GUSPatSynth_SetBankMSB'] = makeInvalidEarlyAccess('_GUSPatSynth_SetBankMSB');
var _GUSPatSynth_SetBankLSB = Module['_GUSPatSynth_SetBankLSB'] = makeInvalidEarlyAccess('_GUSPatSynth_SetBankLSB');
var _GUSPatSynth_SetProgram = Module['_GUSPatSynth_SetProgram'] = makeInvalidEarlyAccess('_GUSPatSynth_SetProgram');
var _GUSPatSynth_SetDrum = Module['_GUSPatSynth_SetDrum'] = makeInvalidEarlyAccess('_GUSPatSynth_SetDrum');
var _GUSPatSynth_ChangePitchWheel = Module['_GUSPatSynth_ChangePitchWheel'] = makeInvalidEarlyAccess('_GUSPatSynth_ChangePitchWheel');
var _GUSPatSynth_RenderShort = Module['_GUSPatSynth_RenderShort'] = makeInvalidEarlyAccess('_GUSPatSynth_RenderShort');
var _GUSPatSynth_RenderFloat = Module['_GUSPatSynth_RenderFloat'] = makeInvalidEarlyAccess('_GUSPatSynth_RenderFloat');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['GUSPatSynth_New'] != 'undefined', 'missing Wasm export: GUSPatSynth_New');
  assert(typeof wasmExports['GUSPatSynth_Load'] != 'undefined', 'missing Wasm export: GUSPatSynth_Load');
  assert(typeof wasmExports['GUSPatSynth_Destroy'] != 'undefined', 'missing Wasm export: GUSPatSynth_Destroy');
  assert(typeof wasmExports['GUSPatSynth_Reset'] != 'undefined', 'missing Wasm export: GUSPatSynth_Reset');
  assert(typeof wasmExports['GUSPatSynth_Unload'] != 'undefined', 'missing Wasm export: GUSPatSynth_Unload');
  assert(typeof wasmExports['GUSPatSynth_Note'] != 'undefined', 'missing Wasm export: GUSPatSynth_Note');
  assert(typeof wasmExports['GUSPatSynth_NoteOffAll'] != 'undefined', 'missing Wasm export: GUSPatSynth_NoteOffAll');
  assert(typeof wasmExports['GUSPatSynth_SetBank'] != 'undefined', 'missing Wasm export: GUSPatSynth_SetBank');
  assert(typeof wasmExports['GUSPatSynth_SetBankMSB'] != 'undefined', 'missing Wasm export: GUSPatSynth_SetBankMSB');
  assert(typeof wasmExports['GUSPatSynth_SetBankLSB'] != 'undefined', 'missing Wasm export: GUSPatSynth_SetBankLSB');
  assert(typeof wasmExports['GUSPatSynth_SetProgram'] != 'undefined', 'missing Wasm export: GUSPatSynth_SetProgram');
  assert(typeof wasmExports['GUSPatSynth_SetDrum'] != 'undefined', 'missing Wasm export: GUSPatSynth_SetDrum');
  assert(typeof wasmExports['GUSPatSynth_ChangePitchWheel'] != 'undefined', 'missing Wasm export: GUSPatSynth_ChangePitchWheel');
  assert(typeof wasmExports['GUSPatSynth_RenderShort'] != 'undefined', 'missing Wasm export: GUSPatSynth_RenderShort');
  assert(typeof wasmExports['GUSPatSynth_RenderFloat'] != 'undefined', 'missing Wasm export: GUSPatSynth_RenderFloat');
  ...
  _GUSPatSynth_New = Module['_GUSPatSynth_New'] = createExportWrapper('GUSPatSynth_New', wasmExports['GUSPatSynth_New'], 2);
  _GUSPatSynth_Load = Module['_GUSPatSynth_Load'] = createExportWrapper('GUSPatSynth_Load', wasmExports['GUSPatSynth_Load'], 5);
  _GUSPatSynth_Destroy = Module['_GUSPatSynth_Destroy'] = createExportWrapper('GUSPatSynth_Destroy', wasmExports['GUSPatSynth_Destroy'], 1);
  _GUSPatSynth_Reset = Module['_GUSPatSynth_Reset'] = createExportWrapper('GUSPatSynth_Reset', wasmExports['GUSPatSynth_Reset'], 1);
  _GUSPatSynth_Unload = Module['_GUSPatSynth_Unload'] = createExportWrapper('GUSPatSynth_Unload', wasmExports['GUSPatSynth_Unload'], 4);
  _GUSPatSynth_Note = Module['_GUSPatSynth_Note'] = createExportWrapper('GUSPatSynth_Note', wasmExports['GUSPatSynth_Note'], 4);
  _GUSPatSynth_NoteOffAll = Module['_GUSPatSynth_NoteOffAll'] = createExportWrapper('GUSPatSynth_NoteOffAll', wasmExports['GUSPatSynth_NoteOffAll'], 2);
  _GUSPatSynth_SetBank = Module['_GUSPatSynth_SetBank'] = createExportWrapper('GUSPatSynth_SetBank', wasmExports['GUSPatSynth_SetBank'], 3);
  _GUSPatSynth_SetBankMSB = Module['_GUSPatSynth_SetBankMSB'] = createExportWrapper('GUSPatSynth_SetBankMSB', wasmExports['GUSPatSynth_SetBankMSB'], 3);
  _GUSPatSynth_SetBankLSB = Module['_GUSPatSynth_SetBankLSB'] = createExportWrapper('GUSPatSynth_SetBankLSB', wasmExports['GUSPatSynth_SetBankLSB'], 3);
  _GUSPatSynth_SetProgram = Module['_GUSPatSynth_SetProgram'] = createExportWrapper('GUSPatSynth_SetProgram', wasmExports['GUSPatSynth_SetProgram'], 4);
  _GUSPatSynth_SetDrum = Module['_GUSPatSynth_SetDrum'] = createExportWrapper('GUSPatSynth_SetDrum', wasmExports['GUSPatSynth_SetDrum'], 3);
  _GUSPatSynth_ChangePitchWheel = Module['_GUSPatSynth_ChangePitchWheel'] = createExportWrapper('GUSPatSynth_ChangePitchWheel', wasmExports['GUSPatSynth_ChangePitchWheel'], 3);
  _GUSPatSynth_RenderShort = Module['_GUSPatSynth_RenderShort'] = createExportWrapper('GUSPatSynth_RenderShort', wasmExports['GUSPatSynth_RenderShort'], 3);
  _GUSPatSynth_RenderFloat = Module['_GUSPatSynth_RenderFloat'] = createExportWrapper('GUSPatSynth_RenderFloat', wasmExports['GUSPatSynth_RenderFloat'], 3);
